...
$(function(){
     ...
     $('#levels').click(()=>{
        ...
        if(levels==0){
          ...
          <a href="/easy.html" class="list-group-item list-group-item-action text-center bg-light" id='easy'>Easy</a>
          <a href="/medium.html" class="list-group-item list-group-item-action text-center bg-primary" id='medium'>Medium</a>
          <a href="/hard.html" class="list-group-item list-group-item-action text-center bg-success" id='hard'>Hard</a>
